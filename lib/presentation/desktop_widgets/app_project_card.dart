          ...
          child: Container(
            ...
            child: IntrinsicHeight(
              child: Row(
                ...
                children: [
                  !widget.isReversed ? _buildTextSection() : _buildImage(),
                  const SizedBox(width: 32),
                  !widget.isReversed ? _buildImage() : _buildTextSection(),
                ],
              ),
            ),
          ),
        ...
        child: _isHovered
            ? Stack(
                children: [
                  ...
                  //         ),
                  //         SizedBox(width: 8),
                  //         Icon(EvaIcons.diagonalArrowRightUp),
                  //       ],
                  //     ),
                  //   ),
                  // ),
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(100),
          color: AppColors.white,
          // boxShadow: [AppBoxShadows.purpleShadowHovered],
        ),
        child: Text(
          title,
          style: TextStyle(
