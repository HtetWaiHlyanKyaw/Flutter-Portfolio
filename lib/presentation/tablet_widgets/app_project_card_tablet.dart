...
class AppProjectCardTablet extends StatefulWidget {
  final String number;
  final String image;
  final String title;
  ...
  @override
  State<AppProjectCardTablet> createState() => _AppProjectCardTabletState();
}

class _AppProjectCardTabletState extends State<AppProjectCardTablet> {
  @override
